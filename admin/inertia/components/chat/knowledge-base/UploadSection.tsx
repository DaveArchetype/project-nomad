...
export default function UploadSection({
  ...
  return (
    <section className="rounded-lg border border-border-subtle bg-surface-primary p-3 md:p-4 space-y-3 md:space-y-4">
      ...
      />
      <div className="flex flex-col md:flex-row justify-center items-stretch md:items-center gap-2 md:gap-3">
      ...
      <div className="flex flex-col md:flex-row md:flex-wrap items-stretch md:items-center justify-between gap-2 md:gap-3 p-3 rounded-lg border border-border-subtle bg-surface-secondary">
          ...
          {(['Always', 'Manual'] as const).map((option) => {
            ...
            return (
              <button
                ...
                className={`flex-1 md:flex-none px-3 py-1.5 text-sm font-medium transition-colors ${
                  isActive
      ...
      >
        ...
        <div className="px-3 pb-3 space-y-2">
          <div className="flex items-start gap-3">
            <div className="shrink-0 w-5 h-5 rounded-full bg-desert-green text-white flex items-center justify-center text-xs font-bold">
              1
            </div>
            <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-text-primary">Enhanced Document Processing with OCR</p>
              <p className="text-sm text-text-secondary">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-text-primary">Information Library Integration</p>
              <p className="text-sm text-text-secondary">
