          ...
          <div className="relative">
            <ListboxButton
              ...
              className={classNames(
                'flex items-center w-full rounded-md bg-surface-primary px-3 py-2 text-base border border-border-default focus:outline-2 focus:-outline-offset-2 focus:outline-primary sm:text-sm/6 text-left',
