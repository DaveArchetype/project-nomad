...
export default class ServiceSeeder extends BaseSeeder {
  ...
  private static DEFAULT_SERVICES: ServiceSeedRecord[] = [
    ...
    {
      service_name: SERVICE_NAMES.COMET,
      friendly_name: 'Comet',
      powered_by: 'Comet',
      display_order: 36,
      description:
        'Debrid-powered Stremio add-on — finds and serves high-quality streams through your debrid service',
      icon: 'IconComet',
      container_image: 'g0ldyy/comet:latest',
      source_repo: 'https://github.com/g0ldyy/comet',
      container_command: null,
      container_config: JSON.stringify({
        HostConfig: {
          RestartPolicy: { Name: 'unless-stopped' },
          PortBindings: { '8000/tcp': [{ HostPort: '8550' }] },
          Binds: [`${ServiceSeeder.NOMAD_STORAGE_ABS_PATH}/comet:/app/data`],
        },
        ExposedPorts: { '8000/tcp': {} },
        Env: ['DATABASE_TYPE=sqlite', 'SCRAPE_TORRENTIO=True', 'SCRAPE_ZILEAN=True'],
      }),
      ui_location: '8550',
      ui_path: '/comet',
      installed: false,
      ...
      category: 'media',
      depends_on: null,
      metadata: JSON.stringify({ minMemoryMB: 512, minDiskMB: 2048 }),
    },
    {
    ...
    },
    {
      ...
      icon: 'IconVoice',
      container_image: 'registry.dasaroff.com/davearchetype/project-nomad-xtts:2.0.1',
      source_repo: 'https://github.com/DaveArchetype/project-nomad',
      container_command: null,
      container_config: JSON.stringify({
        HostConfig: {
