...
export default class ServiceSeeder extends BaseSeeder {
  ...
  private static DEFAULT_SERVICES: ServiceSeedRecord[] = [
    ...
    {
      service_name: SERVICE_NAMES.MEDIAFLOW,
      friendly_name: 'MediaFlow Proxy',
      powered_by: 'MediaFlow',
      display_order: 33,
      description:
        'Streaming proxy with NVIDIA NVENC transcoding — converts HEVC/VP9/AV1 to H.264 for browser playback. Configure Stremio to route streams through it.',
      icon: 'IconPlayerPlay',
      container_image: 'mhdzumair/mediaflow-proxy:v2.4.9',
      source_repo: 'https://github.com/mhdzumair/mediaflow-proxy',
      container_command: null,
      container_config: JSON.stringify({
        HostConfig: {
          RestartPolicy: { Name: 'unless-stopped' },
