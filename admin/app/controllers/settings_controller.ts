...
export default class SettingsController {
    ...
    return inertia.render('settings/voice', {
      voice: {
        settings: {
          ...
          ttsXttsLanguage: ttsXttsLanguage || 'en',
  ...
  async secrets({ inertia }: HttpContext) {
    const [
      ...
      KVStore.getValue('vpn.protocol'),
      KVStore.getValue('vpn.wireguardPrivateKey'),
      KVStore.getValue('vpn.wireguardPublicKey'),
      KVStore.getValue('vpn.wireguardAddresses'),
    ...
    return inertia.render('settings/secrets', {
      secrets: {
        ...
        wireguardPrivateKeyConfigured: Boolean(wireguardPrivateKey),
        wireguardPublicKey: wireguardPublicKey || '',
        wireguardAddresses: wireguardAddresses || '',
